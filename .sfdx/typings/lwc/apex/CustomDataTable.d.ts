...
declare module "@salesforce/apex/CustomDataTable.getRecords" {
  export default function getRecords(param: {objectAPIName: any, fields: any, orderBy: any, orderDirection: any, filters: any, additioinalFilters: any, noOfRefresh: any}): Promise<any>;
}
